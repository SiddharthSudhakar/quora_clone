...
class Development(BaseConfig):
    ...
    # Mongo Settings
    MONGO_DBNAME = os.environ.get('Quora_clone') # TODO-deployment replace with MONGO_DBNAME_DEVELOPMENT
    MONGO_URI = os.environ.get('mongodb://localhost:27017/Quora_clone') # TODO-deployment replace with MONGO_URI_DEVELOPMENT
